...
import com.rm.erp.datasource.mappers.UserMapper;
import com.rm.erp.datasource.mappers.UserMapperEx;
...
public class UserService {
    ...
    public int insertUser(String beanJson, HttpServletRequest request)throws Exception {
        ...
        try{
			...
			/*
			 * logService.insertLog("用户", BusinessConstants.LOG_OPERATION_TYPE_ADD,
			 * request);
			 */
        }catch(Exception e){
    ...
    public int updateUserByObj(User user) throws Exception{
		/*
		 * logService.insertLog("用户", new
		 * StringBuffer(BusinessConstants.LOG_OPERATION_TYPE_EDIT).append(user.getId()).
    ...
    public UserEx registerUser(UserEx ue, Integer manageRoleId, HttpServletRequest request) throws Exception{
        ...
        if(BusinessConstants.DEFAULT_MANAGER.equals(ue.getLoginame())) {
            ...
            //更新租户id
			/*
			 * User user = new User(); user.setId(ue.getId()); user.setTenantId(ue.getId());
    ...
    public void updateUserAndOrgUserRel(UserEx ue) throws Exception{
        if(BusinessConstants.DEFAULT_MANAGER.equals(ue.getLoginame())) {
			...
			/*
			 * logService.insertLog("用户", new
			 * StringBuffer(BusinessConstants.LOG_OPERATION_TYPE_EDIT).append(ue.getId()).
			 * toString(), ((ServletRequestAttributes)
			 * RequestContextHolder.getRequestAttributes()).getRequest());
			 */
            //检查用户名和登录名
